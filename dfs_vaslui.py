# Codigo do Grupo VJGG: Gabriel Porto, Jooo Gabriel Nascimento, Victor Paiva
...
class BuscaProfundidade:
    def __init__(self, problema):
        ...
        self.fronteira = [problema.inicial]  # Usar uma pilha (LIFO)
        self.visitados = set()  # Uso do set
        self.visitados.add(problema.inicial.estado)
        self.solucao = []
...
problema_romenia = Problema(estados_romenia, no_vaslui, lambda no: no.estado == 'Craiova')
